...
//        ftuWarnInfoMapper.deleteByMainId(id);
    ...
    @Override
    public FtuDevice dataById(String id) {
        return baseMapper.dataById(id);
    }

    @Override
    public boolean updateLngLat(double lng, double lat, Integer status, String id) {
        return baseMapper.updateLngLat(lng, lat, status, id);
    }

    @Override
    public List<FtuDeviceMapVO> getIndexList() {
        return baseMapper.getIndexList();
    }
